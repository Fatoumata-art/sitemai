    ...
    <section class="wrapper style1 special">
        <div class="inner">
            ...
            <section class="spotlight">
                <span class="image"><img src="images/assuauto
                .jpg" alt="" /></span>
                <div class="content">
                    <header>
            ...
            <section class="spotlight">
                <span class="image"><img src="images/assubat.jpg" alt="" /></span>
                <div class="content">
                    <header>
                        <h3>Immobilier Neuf</h3>
                    </header>
                    <p>Nous pouvons vous proposer pour votre résidence principale où investissement locatif dans le neuf des appartements et maisons individuelles. 

Une sélection d’appartements, du T1 au T5 et maisons individuelles répartis sur toute la France. 

Proche toutes commodités, transports, écoles et commerces.

Contactez nous si vous souhaitez avoir des informations sur les biens disponibles sur votre zone de recherche. 
</p>
                    <footer>
                        <ul class="actions">
                            <li><a href="#" class="button">Details</a></li>
            ...
            <section class="spotlight">
                <span class="image"><img src="images/assusolo.jpg" alt="" /></span>
                <div class="content">
                    <header>
                        <h3>Assurance Auto-entrepreneur</h3>
                    </header>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dapibus rutrum facilisis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos magna fames ac turpis egestas amet non lorem amet.</p>
                    <footer>
                        <ul class="actions">
